  ...
  namespace :audit do
    task :create_audit_tables do
      ...
      sql.tables.each do |table|
        ...
        add_column table.to_sym, :username, :string
        add_column table.to_sym, :version, :integer, default: 0
        add_column table.to_sym, :deleted, :boolean
        add_column table.to_sym, :canonical_id, :integer
